...
var Autocomplete = /** @class */ (function () {
    ...
    Autocomplete.for = function (editor) {
        ...
        editor.completer.parentNode = editor.container.parentNode;
        return editor.completer;
    };
    return Autocomplete;
}());
...
var CompletionProvider = /** @class */ (function () {
    ...
    CompletionProvider.prototype.insertMatchOriginal = function (editor, data, options) {
        if (!data)
            return false;
    ...
    CompletionProvider.prototype.insertMatch = function (editor, data, options) {
        ...
        if (data.completer && data.completer.insertMatch) {
            data.completer.insertMatch(editor, data, this);
        }
        else {
            if (!this.completions)
                return false;
