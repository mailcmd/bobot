defmodule Bobot.MixProject do
  ...
  defp deps do
    ...
    [
      ...
      {:dns_cluster, "~> 0.1.1"},
      {:bandit, "~> 1.5"},
      {:telegram, git: "https://github.com/mailcmd/telegram.git"},
      {:finch, "~> 0.16"},
      {:table_rex, "~> 4.1.0"},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind bobot", "esbuild bobot"],
      "assets.deploy": [
        "tailwind bobot --minify",
        "esbuild bobot --minify",
        "phx.digest"
      ]
    ]
  end
